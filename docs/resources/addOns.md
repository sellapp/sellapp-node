...
| --- | --- | --- |
| options | `AddOnsListOptions \| undefined` | No |

Returns: `Promise<AutoPaginatable<SdkListAddOnsResponseValue200ApplicationJson, PaginationOptions>>`.
...
Returns: `Promise<SdkSearchAddOnsResponseValue200ApplicationJson>`.
