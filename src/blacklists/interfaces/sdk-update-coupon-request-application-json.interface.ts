...
import type { SdkUpdateCouponRequestApplicationJsonType } from './sdk-update-coupon-request-application-json-type.interface';

export interface SdkUpdateCouponRequestApplicationJson {
  code?: string;
...
export interface SdkUpdateCouponRequestApplicationJsonResponse {
  code?: string;
  type?: SdkUpdateCouponRequestApplicationJsonType | (string & Record<never, never>);
  discount?: number | string;
  store_wide?: boolean;
