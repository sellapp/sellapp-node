...
import type { V2BatchCreateCouponsRequestApplicationJsonPropertyResourcesItemType } from './v-2-batch-create-coupons-request-application-json-property-resources-item-type.interface';

export interface V2BatchCreateCouponsRequestApplicationJsonPropertyResourcesItem {
  code: string;
  type: V2BatchCreateCouponsRequestApplicationJsonPropertyResourcesItemType | (string & Record<never, never>);
...
export interface V2BatchCreateCouponsRequestApplicationJsonPropertyResourcesItemResponse {
  code: string;
  type: V2BatchCreateCouponsRequestApplicationJsonPropertyResourcesItemType | (string & Record<never, never>);
  discount: number | string;
  store_wide: boolean;
