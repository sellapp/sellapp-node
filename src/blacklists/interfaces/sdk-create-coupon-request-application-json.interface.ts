...
import type { SdkCreateCouponRequestApplicationJsonType } from './sdk-create-coupon-request-application-json-type.interface';

export interface SdkCreateCouponRequestApplicationJson {
  code: string;
...
export interface SdkCreateCouponRequestApplicationJsonResponse {
  code: string;
  type: SdkCreateCouponRequestApplicationJsonType | (string & Record<never, never>);
  discount: number | string;
  store_wide: boolean;
