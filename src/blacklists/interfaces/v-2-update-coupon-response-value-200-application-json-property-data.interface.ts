...
import type { V2UpdateCouponResponseValue200ApplicationJsonPropertyDataType } from './v-2-update-coupon-response-value-200-application-json-property-data-type.interface';

export interface V2UpdateCouponResponseValue200ApplicationJsonPropertyData {
  id: number;
  code: string;
  type: V2UpdateCouponResponseValue200ApplicationJsonPropertyDataType | (string & Record<never, never>);
  discount: string;
  limit: number | null;
  storeWide: boolean;
...
export interface V2UpdateCouponResponseValue200ApplicationJsonPropertyDataResponse {
  id: number;
  code: string;
  type: V2UpdateCouponResponseValue200ApplicationJsonPropertyDataType | (string & Record<never, never>);
  discount: string;
