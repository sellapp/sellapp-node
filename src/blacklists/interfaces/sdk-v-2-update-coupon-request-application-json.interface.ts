...
import type { SdkV2UpdateCouponRequestApplicationJsonType } from './sdk-v-2-update-coupon-request-application-json-type.interface';

export interface SdkV2UpdateCouponRequestApplicationJson {
  code?: string;
...
export interface SdkV2UpdateCouponRequestApplicationJsonResponse {
  code?: string;
  type?: SdkV2UpdateCouponRequestApplicationJsonType | (string & Record<never, never>);
  discount?: number | string;
  store_wide?: boolean;
