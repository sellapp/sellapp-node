...
import type { SearchCouponsResponseValue200ApplicationJsonPropertyDataItemType } from './search-coupons-response-value-200-application-json-property-data-item-type.interface';

export interface SearchCouponsResponseValue200ApplicationJsonPropertyDataItem {
  id: number;
  code: string;
  type: SearchCouponsResponseValue200ApplicationJsonPropertyDataItemType | (string & Record<never, never>);
  discount: string;
  limit: number | null;
  storeWide: boolean;
...
export interface SearchCouponsResponseValue200ApplicationJsonPropertyDataItemResponse {
  id: number;
  code: string;
  type: SearchCouponsResponseValue200ApplicationJsonPropertyDataItemType | (string & Record<never, never>);
  discount: string;
