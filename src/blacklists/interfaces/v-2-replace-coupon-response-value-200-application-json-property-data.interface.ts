...
import type { V2ReplaceCouponResponseValue200ApplicationJsonPropertyDataType } from './v-2-replace-coupon-response-value-200-application-json-property-data-type.interface';

export interface V2ReplaceCouponResponseValue200ApplicationJsonPropertyData {
  id: number;
  code: string;
  type: V2ReplaceCouponResponseValue200ApplicationJsonPropertyDataType | (string & Record<never, never>);
  discount: string;
  limit: number | null;
  storeWide: boolean;
...
export interface V2ReplaceCouponResponseValue200ApplicationJsonPropertyDataResponse {
  id: number;
  code: string;
  type: V2ReplaceCouponResponseValue200ApplicationJsonPropertyDataType | (string & Record<never, never>);
  discount: string;
