...
import type { GetCouponResponseValue200ApplicationJsonPropertyDataType } from './get-coupon-response-value-200-application-json-property-data-type.interface';

export interface GetCouponResponseValue200ApplicationJsonPropertyData {
  id: number;
  code: string;
  type: GetCouponResponseValue200ApplicationJsonPropertyDataType | (string & Record<never, never>);
  discount: string;
  limit: number | null;
  storeWide: boolean;
...
export interface GetCouponResponseValue200ApplicationJsonPropertyDataResponse {
  id: number;
  code: string;
  type: GetCouponResponseValue200ApplicationJsonPropertyDataType | (string & Record<never, never>);
  discount: string;
