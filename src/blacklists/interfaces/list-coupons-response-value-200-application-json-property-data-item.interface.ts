...
import type { ListCouponsResponseValue200ApplicationJsonPropertyDataItemType } from './list-coupons-response-value-200-application-json-property-data-item-type.interface';

export interface ListCouponsResponseValue200ApplicationJsonPropertyDataItem {
  id: number;
  code: string;
  type: ListCouponsResponseValue200ApplicationJsonPropertyDataItemType | (string & Record<never, never>);
  discount: string;
  limit: number | null;
  storeWide: boolean;
...
export interface ListCouponsResponseValue200ApplicationJsonPropertyDataItemResponse {
  id: number;
  code: string;
  type: ListCouponsResponseValue200ApplicationJsonPropertyDataItemType | (string & Record<never, never>);
  discount: string;
