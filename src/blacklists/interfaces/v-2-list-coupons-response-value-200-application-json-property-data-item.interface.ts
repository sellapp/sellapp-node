...
import type { V2ListCouponsResponseValue200ApplicationJsonPropertyDataItemType } from './v-2-list-coupons-response-value-200-application-json-property-data-item-type.interface';

export interface V2ListCouponsResponseValue200ApplicationJsonPropertyDataItem {
  id: number;
  code: string;
  type: V2ListCouponsResponseValue200ApplicationJsonPropertyDataItemType | (string & Record<never, never>);
  discount: string;
  limit: number | null;
  storeWide: boolean;
...
export interface V2ListCouponsResponseValue200ApplicationJsonPropertyDataItemResponse {
  id: number;
  code: string;
  type: V2ListCouponsResponseValue200ApplicationJsonPropertyDataItemType | (string & Record<never, never>);
  discount: string;
