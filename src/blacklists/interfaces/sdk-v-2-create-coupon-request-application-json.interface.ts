...
import type { SdkV2CreateCouponRequestApplicationJsonType } from './sdk-v-2-create-coupon-request-application-json-type.interface';

export interface SdkV2CreateCouponRequestApplicationJson {
  code: string;
...
export interface SdkV2CreateCouponRequestApplicationJsonResponse {
  code: string;
  type: SdkV2CreateCouponRequestApplicationJsonType | (string & Record<never, never>);
  discount: number | string;
  store_wide: boolean;
