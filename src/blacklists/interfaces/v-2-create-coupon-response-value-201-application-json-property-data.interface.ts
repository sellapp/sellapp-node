...
import type { V2CreateCouponResponseValue201ApplicationJsonPropertyDataType } from './v-2-create-coupon-response-value-201-application-json-property-data-type.interface';

export interface V2CreateCouponResponseValue201ApplicationJsonPropertyData {
  id: number;
  code: string;
  type: V2CreateCouponResponseValue201ApplicationJsonPropertyDataType | (string & Record<never, never>);
  discount: string;
  limit: number | null;
  storeWide: boolean;
...
export interface V2CreateCouponResponseValue201ApplicationJsonPropertyDataResponse {
  id: number;
  code: string;
  type: V2CreateCouponResponseValue201ApplicationJsonPropertyDataType | (string & Record<never, never>);
  discount: string;
