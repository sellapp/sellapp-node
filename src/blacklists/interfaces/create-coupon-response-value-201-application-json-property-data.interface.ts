...
import type { CreateCouponResponseValue201ApplicationJsonPropertyDataType } from './create-coupon-response-value-201-application-json-property-data-type.interface';

export interface CreateCouponResponseValue201ApplicationJsonPropertyData {
  id: number;
  code: string;
  type: CreateCouponResponseValue201ApplicationJsonPropertyDataType | (string & Record<never, never>);
  discount: string;
  limit: number | null;
  storeWide: boolean;
...
export interface CreateCouponResponseValue201ApplicationJsonPropertyDataResponse {
  id: number;
  code: string;
  type: CreateCouponResponseValue201ApplicationJsonPropertyDataType | (string & Record<never, never>);
  discount: string;
