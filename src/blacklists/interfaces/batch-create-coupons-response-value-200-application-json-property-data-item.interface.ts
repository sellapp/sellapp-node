...
import type { BatchCreateCouponsResponseValue200ApplicationJsonPropertyDataItemType } from './batch-create-coupons-response-value-200-application-json-property-data-item-type.interface';

export interface BatchCreateCouponsResponseValue200ApplicationJsonPropertyDataItem {
  id: number;
  code: string;
  type: BatchCreateCouponsResponseValue200ApplicationJsonPropertyDataItemType | (string & Record<never, never>);
  discount: string;
  limit: number | null;
  storeWide: boolean;
...
export interface BatchCreateCouponsResponseValue200ApplicationJsonPropertyDataItemResponse {
  id: number;
  code: string;
  type: BatchCreateCouponsResponseValue200ApplicationJsonPropertyDataItemType | (string & Record<never, never>);
  discount: string;
