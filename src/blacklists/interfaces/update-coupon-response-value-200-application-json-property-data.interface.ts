...
import type { UpdateCouponResponseValue200ApplicationJsonPropertyDataType } from './update-coupon-response-value-200-application-json-property-data-type.interface';

export interface UpdateCouponResponseValue200ApplicationJsonPropertyData {
  id: number;
  code: string;
  type: UpdateCouponResponseValue200ApplicationJsonPropertyDataType | (string & Record<never, never>);
  discount: string;
  limit: number | null;
  storeWide: boolean;
...
export interface UpdateCouponResponseValue200ApplicationJsonPropertyDataResponse {
  id: number;
  code: string;
  type: UpdateCouponResponseValue200ApplicationJsonPropertyDataType | (string & Record<never, never>);
  discount: string;
