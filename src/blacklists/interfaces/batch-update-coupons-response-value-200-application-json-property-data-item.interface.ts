...
import type { BatchUpdateCouponsResponseValue200ApplicationJsonPropertyDataItemType } from './batch-update-coupons-response-value-200-application-json-property-data-item-type.interface';

export interface BatchUpdateCouponsResponseValue200ApplicationJsonPropertyDataItem {
  id: number;
  code: string;
  type: BatchUpdateCouponsResponseValue200ApplicationJsonPropertyDataItemType | (string & Record<never, never>);
  discount: string;
  limit: number | null;
  storeWide: boolean;
...
export interface BatchUpdateCouponsResponseValue200ApplicationJsonPropertyDataItemResponse {
  id: number;
  code: string;
  type: BatchUpdateCouponsResponseValue200ApplicationJsonPropertyDataItemType | (string & Record<never, never>);
  discount: string;
