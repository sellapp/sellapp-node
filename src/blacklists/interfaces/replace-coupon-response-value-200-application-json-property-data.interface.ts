...
import type { ReplaceCouponResponseValue200ApplicationJsonPropertyDataType } from './replace-coupon-response-value-200-application-json-property-data-type.interface';

export interface ReplaceCouponResponseValue200ApplicationJsonPropertyData {
  id: number;
  code: string;
  type: ReplaceCouponResponseValue200ApplicationJsonPropertyDataType | (string & Record<never, never>);
  discount: string;
  limit: number | null;
  storeWide: boolean;
...
export interface ReplaceCouponResponseValue200ApplicationJsonPropertyDataResponse {
  id: number;
  code: string;
  type: ReplaceCouponResponseValue200ApplicationJsonPropertyDataType | (string & Record<never, never>);
  discount: string;
