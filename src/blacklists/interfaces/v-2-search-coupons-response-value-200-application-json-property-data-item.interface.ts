...
import type { V2SearchCouponsResponseValue200ApplicationJsonPropertyDataItemType } from './v-2-search-coupons-response-value-200-application-json-property-data-item-type.interface';

export interface V2SearchCouponsResponseValue200ApplicationJsonPropertyDataItem {
  id: number;
  code: string;
  type: V2SearchCouponsResponseValue200ApplicationJsonPropertyDataItemType | (string & Record<never, never>);
  discount: string;
  limit: number | null;
  storeWide: boolean;
...
export interface V2SearchCouponsResponseValue200ApplicationJsonPropertyDataItemResponse {
  id: number;
  code: string;
  type: V2SearchCouponsResponseValue200ApplicationJsonPropertyDataItemType | (string & Record<never, never>);
  discount: string;
