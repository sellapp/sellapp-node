...
import type { V2BatchCreateCouponsResponseValue200ApplicationJsonPropertyDataItemType } from './v-2-batch-create-coupons-response-value-200-application-json-property-data-item-type.interface';

export interface V2BatchCreateCouponsResponseValue200ApplicationJsonPropertyDataItem {
  id: number;
  code: string;
  type: V2BatchCreateCouponsResponseValue200ApplicationJsonPropertyDataItemType | (string & Record<never, never>);
  discount: string;
  limit: number | null;
  storeWide: boolean;
...
export interface V2BatchCreateCouponsResponseValue200ApplicationJsonPropertyDataItemResponse {
  id: number;
  code: string;
  type: V2BatchCreateCouponsResponseValue200ApplicationJsonPropertyDataItemType | (string & Record<never, never>);
  discount: string;
