...
import type { V2BatchUpdateCouponsResponseValue200ApplicationJsonPropertyDataItemType } from './v-2-batch-update-coupons-response-value-200-application-json-property-data-item-type.interface';

export interface V2BatchUpdateCouponsResponseValue200ApplicationJsonPropertyDataItem {
  id: number;
  code: string;
  type: V2BatchUpdateCouponsResponseValue200ApplicationJsonPropertyDataItemType | (string & Record<never, never>);
  discount: string;
  limit: number | null;
  storeWide: boolean;
...
export interface V2BatchUpdateCouponsResponseValue200ApplicationJsonPropertyDataItemResponse {
  id: number;
  code: string;
  type: V2BatchUpdateCouponsResponseValue200ApplicationJsonPropertyDataItemType | (string & Record<never, never>);
  discount: string;
